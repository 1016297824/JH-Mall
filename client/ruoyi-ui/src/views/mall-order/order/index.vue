<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="支付过期时间" prop="payExpireTime">
        <el-date-picker clearable
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="支付过期时间" align="center" prop="payExpireTime" width="180">
        <template #default="scope">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="orderRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-table :data="mallOrderItemList" @selection-change="handleMallOrderItemSelectionChange" ref="mallOrderItem" row-key="_rowKey">
...
function handleAddMallOrderItem() {
  let obj = { _rowKey: ++_orderItemRowKey } as MallOrderItem
  obj.spuId = undefined
  obj.skuId = undefined
...
function handleDeleteMallOrderItem() {
  if (checkedMallOrderItem.value.length == 0) {
    ...
    const checkedSet = new Set(checkedMallOrderItem.value)
    mallOrderItemList.value = mallOrderItemList.value.filter((item: any) => !checkedSet.has(item))
  }
}

/** 复选框选中数据 */
function handleMallOrderItemSelectionChange(selection: any[]) {
  checkedMallOrderItem.value = selection
}
