<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="手机号哈希" prop="phoneHash">
        <el-input
          ...
          placeholder="请输入手机号哈希"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="密码哈希" prop="password">
        <el-input
      ...
      <el-form-item label="邮箱哈希" prop="emailHash">
        <el-input
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="密码哈希" align="center" prop="password" />
      <el-table-column label="昵称" align="center" prop="nickname" />
      <el-table-column label="头像 URL" align="center" prop="avatar" />
      <el-table-column label="邮箱" align="center" prop="email" />
      <el-table-column label="邮箱哈希" align="center" prop="emailHash" />
      ...
      <el-table-column label="是否同意隐私协议" align="center" prop="isPrivacyAgreed" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="userRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="手机号哈希" prop="phoneHash">
              <el-input v-model="form.phoneHash" placeholder="请输入手机号哈希" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="密码哈希" prop="password">
              <el-input v-model="form.password" placeholder="请输入密码哈希" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="昵称" prop="nickname">
          ...
          <el-col :span="24">
            <el-form-item label="邮箱哈希" prop="emailHash">
              <el-input v-model="form.emailHash" placeholder="请输入邮箱哈希" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="生日" prop="birthday">
...
const data = reactive({
  ...
  rules: {
    ...
    phoneHash: [
      { required: true, message: "手机号哈希不能为空", trigger: "blur" }
    ],
    password: [
