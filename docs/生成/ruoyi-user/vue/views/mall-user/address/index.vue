<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="地址标签：家 / 公司 / 学校" prop="label">
        <el-input
          v-model="queryParams.label"
          placeholder="请输入地址标签：家 / 公司 / 学校"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="addressList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否默认地址：1=默认 0=非默认" align="center" prop="isDefault" />
      <el-table-column label="地址标签：家 / 公司 / 学校" align="center" prop="label" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="addressRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="地址标签：家 / 公司 / 学校" prop="label">
              <el-input v-model="form.label" placeholder="请输入地址标签：家 / 公司 / 学校" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
