<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['mall-user:growth_log:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['mall-user:growth_log:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['mall-user:growth_log:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['mall-user:growth_log:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="growth_logList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="业务类型：order" align="center" prop="bizType" />
      <el-table-column label="业务单号" align="center" prop="bizNo" />
      <el-table-column label="变动方向：1=增加 2=减少" align="center" prop="changeType" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['mall-user:growth_log:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['mall-user:growth_log:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="growth_logRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="业务单号" prop="bizNo">
...
const data = reactive({
  ...
  rules: {
    ...
    bizType: [
      { required: true, message: "业务类型：order不能为空", trigger: "change" }
    ],
    changeType: [
      { required: true, message: "变动方向：1=增加 2=减少不能为空", trigger: "change" }
    ],
    growth: [
...
function handleExport() {
  proxy.download('mall-user/growth_log/export', {
    ...queryParams.value
