<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="等级名称，如「普通会员」、「银卡会员」、「金卡会员」、「钻石会员」" prop="levelName">
        <el-input
          v-model="queryParams.levelName"
          placeholder="请输入等级名称，如「普通会员」、「银卡会员」、「金卡会员」、「钻石会员」"
          clearable
    ...
    <el-table v-loading="loading" :data="levelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="等级名称，如「普通会员」、「银卡会员」、「金卡会员」、「钻石会员」" align="center" prop="levelName" />
      <el-table-column label="等级值，数值越大等级越高" align="center" prop="levelValue" />
      ...
      <el-table-column label="权益 JSON，如折扣率、免邮费、积分倍数" align="center" prop="benefitsJson" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="levelRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="24">
      <el-form-item label="等级名称，如「普通会员」、「银卡会员」、「金卡会员」、「钻石会员」" prop="levelName">
              <el-input v-model="form.levelName" placeholder="请输入等级名称，如「普通会员」、「银卡会员」、「金卡会员」、「钻石会员」" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="权益 JSON，如折扣率、免邮费、积分倍数" prop="benefitsJson">
...
const data = reactive({
  ...
  rules: {
    levelName: [
      { required: true, message: "等级名称，如「普通会员」、「银卡会员」、「金卡会员」、「钻石会员」不能为空", trigger: "blur" }
    ],
    levelValue: [
      { required: true, message: "等级值，数值越大等级越高不能为空", trigger: "blur" }
    ],
    minGrowth: [
