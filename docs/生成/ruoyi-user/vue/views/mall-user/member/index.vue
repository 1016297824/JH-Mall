<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['mall-user:member:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['mall-user:member:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['mall-user:member:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['mall-user:member:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="memberList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户 ID，与 mall_user 一对一" align="center" prop="userId" />
      <el-table-column label="当前会员等级 ID，关联 mall_user_member_level" align="center" prop="levelId" />
      <el-table-column label="当前成长值" align="center" prop="growth" />
      <el-table-column label="累计获取成长值，仅增不减" align="center" prop="totalGrowth" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['mall-user:member:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['mall-user:member:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
const data = reactive({
  ...
  rules: {
    userId: [
      { required: true, message: "用户 ID，与 mall_user 一对一不能为空", trigger: "blur" }
    ],
    createTime: [
...
function handleExport() {
  proxy.download('mall-user/member/export', {
    ...queryParams.value
