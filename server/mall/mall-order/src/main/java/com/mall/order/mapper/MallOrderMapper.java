...
public interface MallOrderMapper 
{
     ...
     * @return 订单管理
     */
    MallOrder selectMallOrderById(String id);
     ...
     * @return 结果
     */
    int deleteMallOrderById(String id);
     ...
     * @return 结果
     */
    int deleteMallOrderByIds(String[] ids);
     ...
     * @return 结果
     */
    int deleteMallOrderItemByOrderIds(String[] ids);
     ...
     * @return 结果
     */
    int batchMallOrderItem(List<MallOrderItem> mallOrderItemList);
     ...
     * @return 结果
     */
    int deleteMallOrderItemByOrderId(String id);
}
