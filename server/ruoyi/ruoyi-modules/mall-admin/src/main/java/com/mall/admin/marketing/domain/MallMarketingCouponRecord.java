package com.mall.admin.marketing.domain;
...
public class MallMarketingCouponRecord extends BaseEntity
{
    ...
    @Excel(name = "优惠券编码", readConverterExp = "全=局唯一")
    ...
    /** 领取时的券面值快照（单位：分） */
    @Excel(name = "领取时的券面值快照", readConverterExp = "单=位：分")
    ...
    /** 使用（核销）时间 */
    @Excel(name = "使用", readConverterExp = "核=销")
